...
get_ipython().system('unzip -oq data/data103787/segDataset.zip -d segDataset')
...
# tree: 查看文件夹树状结构
# -L: 表示遍历深度
get_ipython().system('tree segDataset -L 2')
...
# 查看label中像素分类情况
get_ipython().system('python show_segDataset_label_cls_id.py')
...
get_ipython().system('python parse_horse_label.py')
...
get_ipython().system('python horse_create_train_list.py')
...
# 解压套件
get_ipython().system('unzip -oq data/data102250/PaddleSeg-release-2.1.zip')
# 通过mv指令实现文件夹重命名
get_ipython().system('mv PaddleSeg-release-2.1 PaddleSeg')
...
get_ipython().system('python PaddleSeg/train.py--config PaddleSeg/configs/quick_start/bisenet_optic_disc_512x512_1k.yml--batch_size 4--iters 2000--learning_rate 0.01--save_interval 200--save_dir PaddleSeg/output--seed 2021--log_iters 20--do_eval--use_vdl')
...
get_ipython().system('python PaddleSeg/val.py--config PaddleSeg/configs/quick_start/bisenet_optic_disc_512x512_1k.yml--model_path PaddleSeg/output/best_model/model.pdparams')
# model_path： 模型参数路径
...
# 进行预测
get_ipython().system('python PaddleSeg/predict.py--config PaddleSeg/configs/quick_start/bisenet_optic_disc_512x512_1k.yml--model_path PaddleSeg/output/best_model/model.pdparams--image_path segDataset/horse/Images--save_dir PaddleSeg/output/horse')
...
# 查看预测结果文件夹分布
get_ipython().system('tree PaddleSeg/output/horse -L 1')
